...
#include "TheLastAugust_UE5_1Character.generated.h"


class UTextRenderComponent;
UCLASS(config=Game)
class ATheLastAugust_UE5_1Character : public ACharacter
{
	GENERATED_BODY()
...
public:
	void OnHealthChanged(float CurrentHealth, float HealthDelta);
...
//Custom component-classes
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Components")
	ULA_CombatComponent* CombatComponent;
